...
public final class FBReader extends Activity {
	...
	public static String userName = "Average Joe";
	public static String userProfileImage = "http://api.ning.com/files/f34gQ23ip-womua6u-G9*L04kq4NuYt9mfCDipabRtExnG28dNEEL-qH3h78ilbTe-GzkRGYVI6zrE83Us1RJwmb4KCvzps3/62731thumbnail.jpg?crop=1%3A1&width=96";
	...
	protected void onCreate(Bundle icicle) {
		...
		OnLongClickListener longListener = new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				Intent intent = new Intent(FBReader.this,
						ReSoViewPagerFragmentActivity.class);
		...
		myFBReaderApp.addAction(ActionCode.SHOW_USER_SETTINGS,
				new ShowUserSettings(this, myFBReaderApp));
	...
	public boolean onUserSettingsRequested() {
		Intent intent = new Intent(FBReader.this,
	...
	private void runCancelAction(Intent intent) {
		...
		try {
			type = CancelMenuHelper.ActionType.valueOf(intent
					.getStringExtra(CancelActivity.TYPE_KEY));
		} catch (Exception e) {
		...
		if (type == CancelMenuHelper.ActionType.returnTo) {
			try {
				bookmark = SerializerUtil.deserializeBookmark(intent
						.getStringExtra(CancelActivity.BOOKMARK_KEY));
			} catch (Exception e) {
